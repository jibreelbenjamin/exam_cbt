        ...
        <div class="mt-5 h-full overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
            ...
            <ul class="flex flex-col gap-y-4">
                ...
                <div class="flex flex-col gap-y-1">
                    <p class="px-5 lg:px-8 pb-1 text-xs text-gray-500 dark:text-neutral-500">INFORMASI PESERTA</p>
                    <!-- Link -->
                    <li class="px-2 lg:px-5">
                    ...
                    <!-- Link -->
                    <li class="px-2 lg:px-5">
                    <a class="{{ ($page == 'cetak-kartu') ? $classPageActive : $classPageInactive }}" href="{{ route('operator.invalid') }}">
                ...
                <div class="flex flex-col gap-y-1">
                    <p class="px-5 lg:px-8 pb-1 text-xs text-gray-500 dark:text-neutral-500">MANAJEMEN UJIAN</p>
                    <!-- Link -->
                    <li class="px-2 lg:px-5">
                    <a class="{{ ($page == 'paket-ujian') ? $classPageActive : $classPageInactive }}" href="{{ route('operator.paket-ujian') }}">
                    ...
                    <!-- Link -->
                    <li class="px-2 lg:px-5">
                    <a class="{{ ($page == 'token') ? $classPageActive : $classPageInactive }}" href="{{ route('operator.invalid') }}">
                ...
                <div class="flex flex-col gap-y-1">
                    <p class="px-5 lg:px-8 pb-1 text-xs text-gray-500 dark:text-neutral-500">MANAJEMEN SOAL</p>
                    <!-- Link -->
                    <li class="px-2 lg:px-5">
                    ...
                    <!-- Link -->
                    <li class="px-2 lg:px-5">
                    <a class="{{ ($page == 'soal') ? $classPageActive : $classPageInactive }}" href="{{ route('operator.soal') }}">
                    ...
                    <!-- Link -->
                    <li class="px-2 lg:px-5">
                    <a class="{{ ($page == 'evaluasi-soal') ? $classPageActive : $classPageInactive }}" href="{{ route('operator.invalid') }}">
                ...
                <div class="flex flex-col gap-y-1">
                    <p class="px-5 lg:px-8 pb-1 text-xs text-gray-500 dark:text-neutral-500">LAPORAN</p>
                    <!-- Link -->
                    <li class="px-2 lg:px-5">
                    <a class="{{ ($page == 'hasil-ujian') ? $classPageActive : $classPageInactive }}" href="{{ route('operator.invalid') }}">
                ...
                <div class="flex flex-col gap-y-1">
                    <p class="px-5 lg:px-8 pb-1 text-xs text-gray-500 dark:text-neutral-500">AREA PENGAWAS</p>
                    <!-- Link -->
                    <li class="px-2 lg:px-5">
                    <a class="{{ ($page == 'monitoring-ujian') ? $classPageActive : $classPageInactive }}" href="{{ route('operator.invalid') }}">
                        ...
                        <div class="ms-auto">
                            <div>
                                <span class="ms-auto inline-flex items-center gap-1.5 py-px px-1.5 rounded-sm text-[10px] leading-4 font-medium bg-red-100 text-red-800 dark:bg-red-800 dark:text-red-300">
                                    LIVE
                                </span>
                            </div>
                        </div>
                ...
                <div class="flex flex-col gap-y-1">
                    <p class="px-5 lg:px-8 pb-1 text-xs text-gray-500 dark:text-neutral-500">KONFIGURASI PENGGUNA</p>
                    <!-- Link -->
                    <li class="px-2 lg:px-5">

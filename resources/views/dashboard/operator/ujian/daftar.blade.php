...
<script>
    ...
    function loadMoreData(reset = false) {
        ...
        fetch(`{{ route('operator.ujian.load') }}?offset=${offset}&limit=${limit}&search=${encodeURIComponent(searchQuery)}`)
            .then(res => res.json())
            .then(data => {
                    ...
                    container.insertAdjacentHTML('beforeend', `
                        <tr class="divide-x divide-gray-200 dark:divide-neutral-700">
                            ...
                            <td class="size-px whitespace-nowrap px-4 py-1">            
                                ...
                                <a href="{{ route('operator.ujian') }}/${item.id_ujian}" type="button" class="size-7 inline-flex justify-center items-center gap-x-2 rounded-lg border border-gray-200 bg-white text-gray-800 shadow-2xs hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden focus:bg-gray-50 dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-300 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700">

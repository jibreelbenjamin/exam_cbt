              ...
              <div class="p-4 space-y-5">
                ...
                <div class="grid sm:grid-cols-12 gap-y-1.5 sm:gap-y-0 sm:gap-x-5">
                  ...
                  <div class="sm:col-span-9">
                    <input type="text" name="token" id="tokenInput" class="py-1.5 sm:py-2 px-3 block w-full border-gray-200 rounded-lg sm:text-sm placeholder:text-gray-400 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-transparent dark:border-neutral-700 dark:text-neutral-300 dark:placeholder:text-white/60 dark:focus:ring-neutral-600" placeholder="Masukan token" autocomplete="off">
                    
                    <div class="flex ml-1 mt-3">
                      <input type="checkbox" name="isRandom" id="randomTokenCheckbox" class="shrink-0 mt-0.5 border-gray-200 rounded-sm text-blue-600 focus:ring-blue-500 checked:border-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800" {{ (old('isRandom')) ? 'checked=""' : '' }}>
                      <label for="randomTokenCheckbox" class="text-sm text-gray-500 ms-3 dark:text-neutral-500">Buat token acak</label>
                    </div>
                  </div>
                  <!-- End Col -->
                ...
                <div class="grid sm:grid-cols-12 gap-y-1.5 sm:gap-y-0 sm:gap-x-5">
                  ...
                  <div class="sm:col-span-9">
                    ...
                    <select data-hs-select='{
                        "apiUrl": "{{ env('API_BASE_URL') }}/ujian/select",
                        "apiQuery": "",
                        "apiSearchQueryKey": "search",
                        "apiDataPart": "data",
                        "apiSelectedValues": ["{{ old('id_ujian') }}"],
                        "apiFieldsMap": {
                          "id": "id_ujian",
                          "val": "id_ujian",
                          "title": "nama",
                        ...
                        "placeholder": "{{ (old('id_ujian') ? 'Ujian terpilih' : 'Pilih ujian...') }}",
...
<script>
  document.addEventListener('DOMContentLoaded', () => {
      const checkbox = document.getElementById('randomTokenCheckbox');
